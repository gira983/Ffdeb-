void* PlayerWeaponOnHand(void* Player){
    void*(*WeaponOnHand)(void*) = (void*(*)(void*))getRealOffset(ENCRYPTOFFSET("0x486A874"));
    return WeaponOnHand(Player);
}

Vector3 CameraPosition(void*Player){ 
	Vector3 Position = Vector3::zero();
    void(*PositionInjected)(void*,Vector3*) = (void(*)(void*,Vector3*))getRealOffset(ENCRYPTOFFSET("0x5899A80"));
...
void* PlayerTakeDamage(void* Player,void* DamageInfo,void* DamagerWeaponDynamicInfo,void* CheckParams,uint DamagerVehicleID){
    void*(*TakeDamage)(void*,void*,void*,void*,uint) = (void*(*)(void*,void*,void*,void*,uint))getRealOffset(ENCRYPTOFFSET("0x158072C"));
...
void PlayerNetworkStartWholeBodyFiring(void* Player,void* WeaponOnHand){
    void(*StartWholeBodyFiring)(void*,void*) = (void(*)(void*,void*))getRealOffset(ENCRYPTOFFSET("0x4A436C8"));
    return StartWholeBodyFiring(Player,WeaponOnHand);
}

void PlayerNetworkStopFire(void* Player,void* WeaponOnHand){
    void(*StopFire)(void*,void*) = (void(*)(void*,void*))getRealOffset(ENCRYPTOFFSET("0x4929520"));
    return StopFire(Player,WeaponOnHand);
}

void* GameFacadeCurrentLocalPlayer(){
    void*(*CurrentLocalPlayer) (void*) = (void*(*)(void*))getRealOffset(ENCRYPTOFFSET("0x3072DF8"));
    return CurrentLocalPlayer(NULL);
}

Vector3 PlayerHeadPosition(void* Player){
    void*(*HeadPosition)(void*) = (void*(*)(void*))getRealOffset(ENCRYPTOFFSET("0x486A874"));
	Vector3 Position = Vector3::zero();
    void(*PositionInjected)(void*,Vector3*) = (void(*)(void*,Vector3*))getRealOffset(ENCRYPTOFFSET("0x5899A80"));
